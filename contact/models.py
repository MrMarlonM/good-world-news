...
class Contact(models.Model):
    ...
    reason = models.CharField(
        max_length=30, choices=CHOICES, default='question')
    ...
    class Meta:
        """
        Orders contact messages by their creation date in descending order.
        """
        ordering = ["-created_on"]

    def __str__(self):
        """
        Returns a string representation of the contact message in the format:
        "[reason] by [name]".
        """
